...
const Main = props => {
    ...
    const [prov12, setProv12] = useState({
        visible: false
    });

    const [john2, setJohn2] = useState({
        visible: false
    });
        ...
        <div>
            <div className="jumbotron">
                ...
                <div className="col-sm-8">
                    <h2 onClick={handleClick3}>Numbers 22:29</h2>
                    {numb22.isToggleOn ?
                ...
                <div className="col-sm-8">
                    <h2 onClick={handleClick4}>Proverbs 12:16</h2>
                    {prov12.isToggleOn ?
                ...
                <div className="col-sm-8">
                    <h2 onClick={handleClick6}>Mark 3:5-6</h2>
                    {mark3.isToggleOn ?
                ...
                <div className="col-sm-8">
                    <h2 onClick={handleClick5}>John 2:13-17</h2>
                    {john2.isToggleOn ?
                ...
                <div className="col-sm-8">
                    <h2 onClick={handleClick7}>James 3:5-6</h2>
                    {jam3.isToggleOn ?
